...
int main(int argc, char ** argv) {
  ...
  //  Edge
  // *******************
  string info_file_path(output_prefix + "-W" + std::to_string(grid_width) + ".adj_info");
  ...
  sort(edges.begin(), edges.end(), EdgeTripletLesserByValue<EdgeType>());
  ...
  string edge_file_path(output_prefix + "-W" + std::to_string(grid_width) + ".adj_edge");
