...
template<typename VertexType, typename EdgeType>
Absgem<VertexType, EdgeType>::Absgem(char *input_prefix) {
  string prefix(input_prefix);
  analysisInfoFile(prefix + ".abs_info");
  ...
  {
    string edge_file_name(prefix + ".abs_edge");
...
template<typename VertexType, typename EdgeType>
Absgem<VertexType, EdgeType>::~Absgem() {
...
template<typename VertexType, typename EdgeType>
void Absgem<VertexType, EdgeType>::analysisInfoFile(string file_name) {
